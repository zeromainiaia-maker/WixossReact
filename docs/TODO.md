...
- **✅ 修正済 4枚（JSON を MANUAL でパッチ・逆翻訳が原文一致・typecheck緑・同型★0）**:
...
- **🪤 トラップ未表現クラスタ（systematic 候補・未着手）**: 原文に【トラップアイコン】見出しがあるが JSON に TRAP_ICON 効果が無いカードが約20枚（WX15-002/017/035/049/082/084/086/092・WX16-028/029/040/041/064/065/066・WX19-058・WX20-062・WX21-025/036・WXEX2-15・SP26-001/002 等＝ただし《トラップアイコン》はルール注記にも出るため要個別精査）。**SET_TRAP（手札を【トラップ】設置）アクション語彙が無い**ため「引く**か**設置」型（WX15-047 等）は機構待ち。BOUNCE/DOWN/TRASH 等で表せる単純トラップ本体のみ横展開可。1ラウンド分の素材。
