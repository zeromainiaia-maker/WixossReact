...
**✅ 完了:** WXDi-P15-076/082（v0.388）。バッチA＝WXDi-P15-080/081/077/078（v0.389）。

**残りのゲート参照シグニ（未実装）:**
- `WXDi-P15-056`（電機）/ `WXDi-P15-057`（地獣）/ `WXDi-P15-058`（宇宙）/ `WXDi-P15-059`（宇宙）
- `WXDi-P16-054`（水獣）/ `WXDi-P16-059`（アーム）/ `WXDi-P16-062`（乗機）/ `WXDi-P16-070`（毒牙）/ `WXDi-P16-074`（古代兵器）
- これらは「同ゾーンゲートのあなたのシグニへ付与（場全体・per-zone gate フィルタ）」「対戦相手のターンの間の付与」「per hand card パワー」等を含み、追加の表現が要るものがある。
