...
最終更新: 2026-06-20（v0.386 まで）。**F-2 は既存機構でクリーンに実装可能な14枚を完了（v0.377〜v0.386・バッチ1〜10）**。残りは F-2 節末の「残り5枚」（ゲート2/相手場1/置換2＝いずれも専用機構/高リスク。**続きは zerom 担当**）。引き継ぎ詳細は BUGFIXES.md 冒頭の各バッチ記録を参照。
