...
| `PIECE_IGNORES_LRIG_COUNT_RULE` | 1 | 1 | WXDi-P16-TK01 |  |
...
| `INTERNAL_OPP_TRASH_UNDER_SIGNI_ZONE` | 0 | 0 |  | stub.value=置くカード、stub.count=ゾーン番号 |
