...
| `PLACE_TRAP_OPTIONAL` | 7 | 7 | WX15-084, WX15-086, WX16-015 | 手札からトラップ設置 |
...
| `LOOK_TOP_COLOR_SORT` | 1 | 1 | WX07-071 | デッキ上N枚を確認して並べ替え |
...
| `SET_HAND_CARD_AS_TRAP` | 1 | 1 | WX21-057 | 手札からトラップ設置 |
...
| `COST_COLOR_SELECT` | 1 | 1 | WX04-063 |  |
