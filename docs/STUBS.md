...
| `SELECT_OTHER_SIGNI` | 1 | 1 | WXDi-P10-052 | （旧 CONDITIONAL_KEYWORD_BY_CENTER_COLOR ハンドラは廃止。SP27-002-E3 を CONTINUOUS GRANT_KEYWORD＋   activeCondition AND(LRIG_COLOR… |
