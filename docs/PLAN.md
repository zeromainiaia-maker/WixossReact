...
### 📌 次の一手（推奨順）
> **cold start＝まず `npm install` → `npm run gates`（全ゲート一括・数秒）が緑になることを確認する。** 現状＝golden **978**・smoke **10726** 全0（SKIP も 0）・fuzz 全0・同型★0・census **1453**（＝`BASELINE_HIGH`・回帰ゲート）・held **254枚/109署名**（2026-07-29 実測）。
>
