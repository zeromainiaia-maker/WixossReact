...
- **🆕 セッション（2026-08-10・続き409〜413・Opus 5）＝§6.4「生ID残存 `[STUB:]` 907箇所の仕分け」を消化。仕分け計器 `npm run census:stubs` を新設し、A群（無言の no-op）を6件実装（12→7）**。
