...
**▶ 次の一手**＝**§5.1 に残るのは「続き616〜634 の21バッチ」だけ**（段2 の parser/engine 改変ぶんの実機確認）。⚠**§5.3 O-49**（バニッシュ先変更のアタッカー側ミラー）も新規在庫。
...
> 🏁**2026-08-24＝`V-nn` エントリは 🅱／🅲／🅳 すべて残0クローズ**（V-04/16/19/30/35/44/45/58/63/83/84/85/86/87）。**残っているのは 続き616〜634 の21バッチだけ**（段2 の parser/engine 改変ぶん・特に実機経路へ直接触ったのは第34「0枚選択可の UI」・第37「クラッシュ主体の限定」・第38「群割当の決定可否」・第40「`END_OF_ATTACK`」）。
...
- **2026-08-24 続き637 後（本行が直近の正）**：
  ...
  **実機シナリオ定義総数 511**（+35＝V-84/85/83/04/16/87/86/30/35/44/45/63 と O-47/O-48）、version **0.502**。（⚠`census:goldentypes` は続き552d 以降 未再計測）
