...
✅**進捗は3つの計器を併記する**（2026-08-27 ユーザー決定・§3）＝**Sheet1 要対応 66枚／台帳 OPEN 631／census 536**。⚠**単独の計器に固定しない**（B6＝11効果直して Sheet1 は 0 減・続き679＝計器のバグを直しただけで率が動いた）。**着手時に「今回どれが動く見込みか」を宣言する。**
