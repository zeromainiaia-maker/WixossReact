...
### 📌 次の一手（推奨順）
> **cold start＝まず `npm install` → `npm run gates`（全ゲート一括・数秒）が緑になることを確認する。** 現状＝golden **1203**・smoke **10679** 全0（SKIP も 0）・fuzz 全0・同型★0・census **1357**（回帰ゲート）・held **250枚/98署名**（2026-07-31 タスク16 残0クローズ後に実測）。
>
