...
- 直近：A3 で WXDi-P11-032 の3択GRANT脱落（アサシン/ランサー/常アタック不可）を CHOOSE に復元、WXDi-CP02-074/089 の先頭【自】脱落を復元（いずれも MANUAL・同型★0維持）。先行して実バグ候補3枚＋トラップ本体2枚を MANUAL 修正、付与引用（GRANT_QUOTED）の decompiler 描画を改良。
