...
| STUB ID | カード | 効果概要 |
|---------|--------|---------|
| EXILE_SELF_AFTER_USE | PR-378 | 使用後このカードをゲームから除外する |
| GROW_CENTER_IF_LEVEL_LTE_OPP | WXK02-029 | センタールリグが相手レベル以下の場合グロウする |
| TRASH_ATTACHED_OR_UNDER_CARD | WXK10-018 | シグニに付いているカード/下のカード1枚をトラッシュ（コスト） |
| ATTACH_SEARCHED_AS_ACCE | WXK10-074 | サーチしたカードを対象シグニのアクセにする（手札経由近似） |
| GAIN_LRIG_BARRIER | WX24-P1-001, WX25-P3-001 | 【ルリグバリア】1つを得る（バリアトークン機構未実装） |
