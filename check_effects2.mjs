...
const VALID_TIMINGS = new Set([
  ...
  'ON_SIGNI_DOWN','ON_SIGNI_ENTERS','ON_SIGNI_BANISH_OPPONENT',
  'ON_SIGNI_BANISH_BATTLE','ON_SIGNI_POWER_ZERO_OR_LESS',
  'ON_LEAVE_FIELD','ON_HAND_DISCARDED','ON_OPP_EFFECT_TRASH_FROM_HAND',
  'ON_OPPONENT_SIGNI_TRASHED','ON_OPPONENT_SIGNI_PLAY',
]);
