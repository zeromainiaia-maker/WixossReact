...
export const MANUAL_EFFECTS: Record<string, CardEffect[]> = {
  ...
  "WX06-014": [
    {"effectId":"WX06-014-E2","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"exceed":1},"action":{"type":"SEQUENCE","steps":[{"type":"TRANSFER_TO_DECK","source":{"type":"TRASH_CARD","owner":"self","count":5,"filter":{"cardType":"シグニ","story":"古代兵器"}},"shuffle":false,"position":"bottom"},{"type":"CONDITIONAL","condition":{"type":"IS_MY_TURN"},"then":{"type":"BANISH","target":{"type":"SIGNI","owner":"opponent","count":1,"filter":{"cardType":"シグニ"},"upToCount":false}}}]},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL","usageLimit":"once_per_turn"},
  ],
  "WX09-Re03": [
  ...
  "WXDi-D02-18AT": [
    {"effectId":"WXDi-D02-18AT-E1","effectType":"AUTO","timing":["ON_PLAY"],"action":{"type":"SEQUENCE","steps":[{"type":"REVEAL_AND_PICK","owner":"self","revealCount":5,"filter":{"cardType":"シグニ","cardClass":"バーチャル"},"pickCount":2,"pickUpTo":true,"then":{"type":"ADD_TO_FIELD","owner":"self","suppressOnPlay":true},"remainder":{"location":"deck","position":"bottom"}}]},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL"},
  ],
  "WXDi-D02-29": [
  ...
  "WXDi-D05-007": [
    {"effectId":"WXDi-D05-007-E1","effectType":"AUTO","timing":["ON_PLAY"],"action":{"type":"SEQUENCE","steps":[{"type":"REVEAL_AND_PICK","owner":"self","revealCount":5,"filter":{"cardType":"シグニ"},"pickCount":1,"then":{"type":"ADD_TO_FIELD","owner":"self","suppressOnPlay":true},"remainder":{"location":"deck","position":"bottom"}}]},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL"},
  ],
  "WXDi-D05-021": [
  ...
  "WXDi-P00-043": [
    {"effectId":"WXDi-P00-043-E1","effectType":"AUTO","timing":["ON_PLAY"],"action":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":2,"filter":{"cardName":"コード２４３４　アルス・アルマル"},"pickCount":1,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL"},
  ],
  "WXDi-P01-085": [
  ...
  "WXDi-P04-047": [
    {"effectId":"WXDi-P04-047-E1","effectType":"AUTO","timing":["ON_PLAY"],"action":{"type":"SEQUENCE","steps":[{"type":"REVEAL_AND_PICK","owner":"self","revealCount":3,"filter":{"cardType":"シグニ","cardClass":"天使"},"pickCount":1,"pickUpTo":true,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},{"type":"CONDITIONAL","condition":{"type":"LAST_PROCESSED_COUNT_GTE","value":1},"then":{"type":"TRASH","target":{"type":"HAND_CARD","owner":"self","count":1}}}]},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL"},
  ],
  "WXDi-P04-065": [
  ...
  "WXDi-P13-027": [
    {"effectId":"WXDi-P13-027-E1","effectType":"AUTO","timing":["ON_PLAY"],"action":{"type":"LOOK_PICK_CHAIN","owner":"self","revealCount":5,"stages":[{"filter":{"cardType":"シグニ"},"pickCount":1,"then":"hand","pickUpTo":true},{"filter":{"cardType":"シグニ","nonColorless":true},"pickCount":1,"then":"hand","sharesClassWithPrev":true,"pickUpTo":true}],"remainder":{"location":"deck","position":"bottom"}},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL"},
  ],
  "WXDi-P13-082": [
  ...
  "WXDi-P16-060": [
    {"effectId":"WXDi-P16-060-E1","effectType":"AUTO","timing":["ON_TURN_END"],"action":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":4,"filter":{"cardType":"シグニ","hasGuard":true},"pickCount":1,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL"},
  ],
  "WXDi-CP01-040": [
  ...
  "WXDi-CP02-025": [
    {"effectId":"WXDi-CP02-025-E1","effectType":"AUTO","timing":["ON_PLAY"],"action":{"type":"LOOK_PICK_CHAIN","owner":"self","revealCount":5,"stages":[{"filter":{"cardType":"シグニ"},"pickCount":1,"then":"hand","pickUpTo":true},{"filter":{"cardType":"シグニ","nonColorless":true},"pickCount":1,"then":"hand","sharesClassWithPrev":true,"pickUpTo":true}],"remainder":{"location":"deck","position":"bottom"}},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL"},
  ],
  "WXDi-CP02-052": [
  ...
  "WX24-P1-020": [
    {"effectId":"WX24-P1-020-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"赤","count":0}]},"action":{"type":"SEQUENCE","steps":[{"type":"BANISH","target":{"type":"SIGNI","owner":"opponent","count":1,"filter":{"cardType":"シグニ","powerRange":{"max":10000}},"upToCount":false}},{"type":"REVEAL_AND_PICK","owner":"self","revealCount":5,"filter":{"cardType":"シグニ","story":"宝石"},"pickCount":2,"remainder":{"location":"deck","position":"bottom"},"then":{"type":"SEQUENCE","steps":[{"type":"REVEAL"},{"type":"ADD_TO_HAND","owner":"self"}]}}]},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WX24-P1-036": [
    {"effectId":"WX24-P1-036-E1","effectType":"AUTO","timing":["ON_PLAY"],"action":{"type":"SEQUENCE","steps":[{"type":"REVEAL_AND_PICK","owner":"self","revealCount":5,"filter":{"cardType":"シグニ","level":{"max":2}},"pickCount":2,"pickUpTo":true,"then":{"type":"ADD_TO_FIELD","owner":"self","suppressOnPlay":true},"remainder":{"location":"deck","position":"bottom"}}]},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL"},
  ],
  "WX24-P1-053": [
    {"effectId":"WX24-P1-053-E1","effectType":"AUTO","timing":["ON_TURN_END"],"action":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":3,"filter":{"cardType":"シグニ","cardClass":"宝石"},"pickCount":1,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL","condition":{"type":"TURN_HAND_DISCARD_GTE","value":1}},
  ],
  "WX24-P1-081": [
  ...
  "WX24-P2-049": [
    {"effectId":"WX24-P2-049-E2","effectType":"AUTO","timing":["ON_PLAY"],"cost":{"energy":[{"color":"白","count":1}]},"action":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":3,"pickCount":1,"pickUpTo":true,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WX24-P2-061": [
    {"effectId":"WX24-P2-061-E1","effectType":"AUTO","timing":["ON_ATTACK_SIGNI"],"action":{"type":"SEQUENCE","steps":[{"type":"STUB","id":"OPPONENT_PAY_OPTIONAL","costColors":["無"]},{"type":"CONDITIONAL","condition":{"type":"IS_MY_TURN"},"then":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":3,"filter":{"cardType":"シグニ","cardClass":"龍獣"},"pickCount":1,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}}}]},"duration":"INSTANT","mandatory":true,"parseStatus":"MANUAL","triggerScope":"self"},
  ],
  "WX24-P3-032": [
  ...
  "WX24-P4-061": [
    {"effectId":"WX24-P4-061-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"白","count":1}]},"action":{"type":"CONDITIONAL","condition":{"type":"LRIG_LEVEL","owner":"self","operator":"gte","value":4},"then":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":5,"filter":{"cardType":"シグニ"},"pickCount":2,"pickUpTo":true,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},"else":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":5,"filter":{"cardType":"シグニ","level":{"max":2}},"pickCount":2,"pickUpTo":true,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}}},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WX24-P4-069": [
  ...
  "WX25-P1-039": [
    {"effectId":"WX25-P1-039-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"青","count":0}]},"action":{"type":"SEQUENCE","steps":[{"type":"LOOK_PICK_CHAIN","owner":"self","revealCount":5,"stages":[{"filter":{"cardType":"シグニ","cardClass":"原子"},"pickCount":1,"then":"hand","pickUpTo":true},{"filter":{"cardType":"シグニ","cardClass":"原子"},"pickCount":1,"then":"field","pickUpTo":true}],"remainder":{"location":"deck","position":"bottom"}},{"type":"BANISH","target":{"type":"SIGNI","owner":"opponent","count":1,"upToCount":false,"filter":{"cardType":"シグニ","levelLteLastProcessed":true}}}]},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WX25-P2-005": [
  ...
  "WX25-P2-046": [
    {"effectId":"WX25-P2-046-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"無","count":0}]},"action":{"type":"SEQUENCE","steps":[{"type":"REVEAL_AND_PICK","owner":"self","revealCount":4,"filter":{"colorMatchesLrig":true},"pickCount":2,"pickUpTo":true,"pickNoun":"カード","then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},{"type":"STUB","id":"PLACE_LIMIT_UPPER"}]},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WX25-P2-066": [
  ...
  "WX26-CP1-019": [
    {"effectId":"WX26-CP1-019-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"無","count":0}]},"action":{"type":"CHOOSE","choose_count":1,"from_count":2,"choices":[{"choiceId":"c0","label":"選択肢1","action":{"type":"SEQUENCE","steps":[{"type":"BOUNCE","target":{"type":"SIGNI","owner":"opponent","count":1,"filter":{"cardType":"シグニ","powerRange":{"max":10000}},"upToCount":false}},{"type":"LOOK_PICK_CHAIN","owner":"self","revealCount":5,"stages":[{"filter":{"cardClass":"プリオケ"},"pickCount":1,"then":"energy","pickNoun":"カード","pickUpTo":true},{"filter":{"cardClass":"プリオケ","color":"白"},"pickCount":1,"then":"hand","pickNoun":"カード","pickUpTo":true}],"remainder":{"location":"deck","position":"bottom"}}]}},{"choiceId":"c1","label":"選択肢2","action":{"type":"SEQUENCE","steps":[{"type":"POWER_MODIFY","target":{"type":"SIGNI","owner":"opponent","count":1,"filter":{"cardType":"シグニ"},"upToCount":false},"delta":-10000,"duration":"UNTIL_END_OF_TURN"},{"type":"LOOK_PICK_CHAIN","owner":"self","revealCount":5,"stages":[{"filter":{"cardClass":"プリオケ"},"pickCount":1,"then":"energy","pickNoun":"カード","pickUpTo":true},{"filter":{"cardClass":"プリオケ","color":"黒"},"pickCount":1,"then":"hand","pickNoun":"カード","pickUpTo":true}],"remainder":{"location":"deck","position":"bottom"}}]}}]},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WX26-CP1-020": [
    {"effectId":"WX26-CP1-020-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"無","count":0}]},"action":{"type":"SEQUENCE","steps":[{"type":"REVEAL_AND_PICK","owner":"self","revealCount":4,"filter":{"story":"プリオケ"},"pickCount":2,"pickUpTo":true,"pickNoun":"カード","then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},{"type":"STUB","id":"PLACE_LIMIT_UPPER"}]},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WX24-D1-25": [
    {"effectId":"WX24-D1-25-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"白","count":1}]},"action":{"type":"CONDITIONAL","condition":{"type":"LRIG_TRASH_COUNT","cardType":"アーツ","operator":"gte","value":5,"excludeSource":true},"then":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":5,"filter":{"cardType":"シグニ"},"pickCount":2,"pickUpTo":true,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},"else":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":5,"filter":{"cardType":"シグニ","level":{"max":2}},"pickCount":2,"pickUpTo":true,"then":{"type":"ADD_TO_HAND","owner":"self"},"remainder":{"location":"deck","position":"bottom"}}},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WXK02-037": [
  ...
  "WXK02-045": [
    {"effectId":"WXK02-045-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"白","count":1}]},"action":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":4,"filter":{"cardType":"シグニ","cardClass":"遊具"},"pickCount":2,"pickUpTo":true,"then":{"type":"ADD_TO_ENERGY","owner":"self"},"remainder":{"location":"deck","position":"top"}},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WXK02-084": [
  ...
  "WDK14-008": [
    {"effectId":"WDK14-008-E1","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"赤","count":1}]},"action":{"type":"SEQUENCE","steps":[{"type":"LOOK_PICK_CHAIN","owner":"self","revealCount":4,"stages":[{"pickCount":1,"then":"hand","pickNoun":"カード"},{"pickCount":1,"then":"beat","pickNoun":"カード"}],"remainder":{"location":"deck","position":"bottom"}},{"type":"BANISH","target":{"type":"SIGNI","owner":"opponent","count":1,"upToCount":false,"filter":{"cardType":"シグニ","levelEqLastProcessed":true}}}]},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WDK14-013": [
  ...
  "SPDi47-05": [
    {"effectId":"SPDi47-05-E2","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"energy":[{"color":"黒","count":0}]},"action":{"type":"SEQUENCE","steps":[{"type":"RECOLLECT_GATE","minArts":4},{"type":"BANISH_REDIRECT","target":{"type":"SIGNI","owner":"opponent","count":"ALL"},"redirectTo":"exile","until":"END_OF_TURN"},{"type":"STUB","id":"POWER_MOD_PER_COUNT"},{"type":"STUB","id":"RULE_REMINDER_TEXT"}]},"duration":"UNTIL_END_OF_TURN","mandatory":false,"parseStatus":"MANUAL","usageLimit":"once_per_game"},
  ],
  "PR-Di035": [
  ...
  ,
    {"effectId":"WX25-P1-052-E2","effectType":"ACTIVATED","timing":["MAIN"],"cost":{"down_self":true},"action":{"type":"REVEAL_AND_PICK","owner":"self","revealCount":3,"filter":{"cardType":"シグニ","story":"天使"},"pickCount":1,"then":{"type":"ADD_TO_FIELD","owner":"self"},"remainder":{"location":"deck","position":"bottom"}},"duration":"INSTANT","mandatory":false,"parseStatus":"MANUAL"},
  ],
  "WX25-P1-103": [
