...
export const MANUAL_EFFECTS: Record<string, CardEffect[]> = {
  ...
  // タスク12(viii)（続き137）: 第1能力「【自】ターン終了時、手札を1枚捨ててもよい。そうした場合、次の対戦相手のターン終了時まで、あなたのすべての＜ブルアカ＞のシグニのパワーを＋4000する」が parser に丸ごと欠落していた（E1=絆自のみ）。E1=第1能力、E2=既存の絆自（ON_ATTACK_PHASE_START）を relabel。TRASH HAND_CARD optional+CONDITIONAL(IS_MY_TURN) は WX24-P4-050-E1 と同型。
  "WX25-CP1-062": [
