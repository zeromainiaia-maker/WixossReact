...
export const ACTIVE_CONDITION_TYPES: Record<ActiveCondition['type'], true> = {
  ...
  HAS_KEY_IN_FIELD: true, ALL_FIELD_SIGNI_MATCH: true, COUNT_THRESHOLD: true, FIELD_SIGNI_POWER_COUNT: true, SELF_POWER_THRESHOLD: true,
...
export const CONDITION_TYPES: Record<Condition['type'], true> = {
  ...
  THIS_CARD_IS_ARMORED: true, THIS_CARD_IS_AWAKENED: true, THIS_CARD_IS_ACCED: true, THIS_CARD_HAS_ATTACHED: true,
...
export interface LookPickChainStage {
  ...
  then: 'hand' | 'energy' | 'trash' | 'field' | 'beat' | 'deck_top' | 'trap' | 'magic_box';
