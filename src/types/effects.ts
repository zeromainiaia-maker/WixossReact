...
export type EffectTiming =
  ...
  | 'ON_COIN_PAID'              // あなたが《コイン》を1枚以上支払ったとき（WXDi-P15-055/069・WXDi-P16-057）。engine配線済（C1・2026-06-29）＝コイン支払の各サイト（グロウ人間/CPU・シグニ【起】・キープレイ・シグニ【出】・アーツ ベット/アンコール・**スペルカットインのベット**〔タスク12(lxxxiv)・2026-08-03〕）で collectCoinPaidTriggers が発火。⚠スペル本体のベット（castSpell の betCoins＝ベット持ちスペル7枚）だけは未配線＝コインは支払うが反応【自】を積まない（実機未検証(C2)）
