...
import {collectTargetedTriggers as pureCollectTargetedTriggers, collectCoinPaidTriggers as pureCollectCoinPaidTriggers, collectPowerZeroTriggers as pureCollectPowerZeroTriggers, collectAnyZoneTrashSelfTriggers as pureCollectAnyZoneTrashSelfTriggers, collectTrashTriggers as pureCollectTrashTriggers, collectBanishTriggers as pureCollectBanishTriggers, collectDrawTriggers as pureCollectDrawTriggers, collectRefreshTriggers as pureCollectRefreshTriggers, collectSelfEventTriggers as pureCollectSelfEventTriggers, collectZoneMovedTriggers as pureCollectZoneMovedTriggers, collectOppOwnedSpellUseTriggers as pureCollectOppOwnedSpellUseTriggers, collectDriveBecameTriggers as pureCollectDriveBecameTriggers, collectBeatBecameTriggers as pureCollectBeatBecameTriggers, collectHandDiscardTriggers as pureCollectHandDiscardTriggers, collectFieldTriggers as pureCollectFieldTriggers, collectTurnTriggers as pureCollectTurnTriggers, collectSigniDownUpTriggers as pureCollectSigniDownUpTriggers, recordSigniDownedThisTurn, isOptionalOwnOnPlayForNormalSummon, isSigniOwnOnPlaySuppressed, onPlayOriginMatches, wrapOptionalOnPlay, type TrigCtx, type TargetedOrigin} from '../engine/triggerCollect';
...
import {CPU_PLAYER_ID, CPU_ACTION_DELAY, generateUUID, shuffle, InstanceMap, assignInstanceIds, assignGuestInstanceIds, drawCards, jankenWinner, isSelectedPowerZeroBanishRedirect, keyActivatedTimingMatchesPhase, canUseArtsCondition, isPieceCardType} from './battle/battleUtils';
...
import {meetsRestriction, effectiveLrigClass, listGrowCandidates, canGrowNow, declaredSigniOverride} from './battle/growLogic';
...
import {clearEndOfTurnDelayedTriggers, consumeOnceDelayedTriggers} from './battle/delayedTrigger';
...
import {resolvePendingSigniBattleFor as resolvePendingSigniBattleImpl, powerZeroBanishCandidates} from './battle/controller/resolveSigniBattle';
...
import {makeTrigCtxForPhase} from './battle/controller/execCtxDeps';
...
import {finalizeUsedCardPlacement} from './battle/spellPlacement';
...
import {activateTurnStartScopedState, applyForcedTurnEnd, clearAttackPhaseScopedState, clearMainPhaseScopedState, clearTurnEndScopedState, closeTeamPieceCutinWindow} from './battle/turnScopedState';
...
export default function BattleScreen({ user, roomId, myDeckId, cards, onBack }: Props) {
   ...
   */
  // 本体は `controller/execCtxDeps.ts` `makeTrigCtxForPhase`（2026-09-18・移設先と共用）。
  const mkTrigCtxForPhase = makeTrigCtxForPhase({ bs, effectsMap, cardMap: battleCardMap, trigCtx: mkTrigCtx });
