...
const BASELINE_ECHO_IDS = 46;  // 2026-09-13 O-356 払い戻し①＝payload を持つ10 id（COPY_LRIG_NAME_ABILITY / DESIGNATE_SIGNI_ZONE / DEPLOY_RESTRICT / GAIN_SIGNI_BARRIER / PICK_FROM_TRASHED_CARDS / COLLAB / DECLARE_CLASS / SET_OPP_SIGNI_AS_TRAP / CAST_FROM_OPP_TRASH / DOWN_UP_SIGNI_AND_CHOOSE）を payload から描いた後の実数。新設時は 56
