...
const BASELINE = 54; // 🔻**54**（2026-09-14・§5.3 `O-372` 第2バッチ）＝`WXK03-025-E2` の defer を実装し、ラベルに「引いた枚数と同じ枚数」が出たぶんの払い戻し（**消化**＝ラベル整備は numberdrift の払い戻しでもある／`O-354` と同型）。以前＝55（2026-09-14・§5.3 O-370①）＝`WXDi-P06-006-E1` の実働 guardAltHand と重複していた defer を除去し、原文の「3枚」が正規の逆翻訳だけで出るようになった。以前＝56：
