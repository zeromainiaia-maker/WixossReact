...
65. 🔑**《ヘブン》はアタックによるダウンでだけ起きる**（2026-09-16・ユーザー判断）。
    ...
    ⚠**相方のダウンは理由を問わない**＝アタックしたシグニがダウンした時点で、クロスしている他のシグニが
    **効果などアタック以外でダウンしていても**ヘブンは成立する（同日ユーザー判断）。⇒ 「相方がアタックしていないのにヘブンする」も報告しない。

66. 🔑**【チャーム】が既に付いているシグニには新しい【チャーム】を付けられない**（2026-09-16・ユーザー判断・「O-528」 読みA）。
    「〜をそれの【チャーム】にする」の対象候補から 【チャーム】付きのシグニが外れるのは正しい。付けられる相手がいなければ何も起きない（カードも動かない）。
    ⇒ **「【チャーム】付きのシグニが候補に出ない」ことを報告しない。** 逆に【チャーム】付きのシグニに付いて古い【チャーム】が消えたら BUG。
