...
const BASELINE_HIGH = 1992; // 続き197(Opus): タスク12(viii)残＝WX26-CP1-048 出自条件機構（THIS_CARD_PLACED_BY_CLASS＝signi_placed_by_source 記録＋LAST_PROCESSED_SHARES_COLOR_WITH_LRIG＋相手エナチャージ）を MANUAL 化で 1993→1992 改善＝実数更新。旧1993は続き196(viii)
