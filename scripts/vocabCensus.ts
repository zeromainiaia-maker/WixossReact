...
const PATTERNS: Pattern[] = [
  ...
  },
  {
    ...
    keys: ['levelEq', 'colorMatchesLrig', 'sameAs', '"same"', 'sameLevel', 'sameName', 'sameColor',
      'levelEqualsVar', 'SAME_', 'nameEq', 'fetchCardName'], // nameEq*=バッチ5b（nameEqLastProcessed）・fetchCardName=PR-470A 名指しフェッチ
  },
  {
    name: '共通する色',
    re: /共通する色/,
