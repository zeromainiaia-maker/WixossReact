...
const BASELINE_HIGH = 1510; // §3タスク12(xxix) G154族: REMOVE_ABILITIES が原文「N体まで」を読まず常に count:1 だった過小実行を是正し1511→1510（機能実装＝WXDi-P03-024/WXDi-P13-043/WXK10-016/WX24-P1-002 の4効果が2体まで消せるようになった）。⚠この1件は本バッチ中に計器のマスクが剥がれて表面化したもの＝従来は無意味な `upToCount:false` がキー `'upTo'` に部分一致して「対応済み」に見えていた偽陰性。G154族12効果（union＋escapeDiscard）自体は census に対応パターンが無く増減しない。
