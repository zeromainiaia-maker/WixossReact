...
function main(): void {
  ...
  // 2026-08-02 task12(lxxxiii) 第12波: WXEX2-19-E2 の field-sourceアクセ実働化で1291→1290。
  // BASELINE_HIGH の行内履歴は旧推移の保存用。現行ゲート値はここで明示する。
  const currentBaselineHigh = BASELINE_HIGH - 1;
