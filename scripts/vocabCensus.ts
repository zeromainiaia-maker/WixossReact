...
function main(): void {
  ...
  // 2026-08-02 task12(lxxxiii) 第7波: WXDi-D02-25-E1 の leave-field trigger 主語を live 忠実化した機能改善（1294→1293）。理由の全履歴は BASELINE_HIGH の行内コメント。
