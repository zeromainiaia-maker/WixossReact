...
const BASELINE_HIGH = 1532; // 続き76: timing 語彙追加（ON_ACCE/ON_ACCE_ATTACH/ON_REFRESH/ON_ENERGY_TO_TRASH/ON_SIGNI_FROZEN/ON_OPP_POWER_DECREASED/ON_DISCARDED_AS_COST/ON_GUARD/ON_OPP_ARTS_USE）で 1537→1532。§3 Opusタスク16
