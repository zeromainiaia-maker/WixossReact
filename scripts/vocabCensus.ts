...
const BASELINE_HIGH = 1998; // 続き188(Opus): タスク12(xxx)＝「対戦相手のシグニが場に出たとき」ON_PLAY scope/対象幻覚是正（WXEX2-76/WX08-006/WXK10-048 の any_opp scope・charm owner・isTriggerSource）で 2001→1998 改善＝実数更新。旧2001は続き182(xxxii)
