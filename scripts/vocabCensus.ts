...
const BASELINE_HIGH = 1970; // 続き199: look-pick「カード名に《盾》を含むシグニ1枚を手札に加え、残りをデッキ上」1効果を既存cardNameのREVEAL_AND_PICKへ是正し1971→1970。旧1971は続き198＝class/color/level filter 40枚
