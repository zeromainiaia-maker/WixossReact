...
const BASELINE_HIGH = 1941; // 続き209: タスク12(xxii) 第1バッチ（IS_MY_TURN化→LAST_PROCESSED_COUNT_GTE 5効果・1945→1942）＋先頭対象指定の照応拡張3効果（1942→1941）。旧: 続き207 ON_HAND_ADDED 等（1948→1945）
