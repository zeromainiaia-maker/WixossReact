...
const BASELINE_HIGH = 1477; // 続き101(Sonnet): semantic audit スケールアップ（119枚精査）で見つかった単点是正可能なJSONバグ21件を修正（owner/filter/duration/thisCardOnly等の既存語彙のみ・parser/engine不変）で 1479→1477
