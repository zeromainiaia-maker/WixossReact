...
const BASELINE_HIGH = 1916; // 続き218（Opus）: 「場に＜C＞/(色)のシグニがN種類以上ある場合」＝HAS_CARD_IN_FIELD の distinctNames を parser 語彙＋engine evalCondition に実装（1919→1916）。旧: 続き215 絆マーカー（【絆常/自/起/出】）を効果ブロック境界として認識＝134カード137能力の飲み込みを解消（1928→1919）。旧: 続き214 タスク6在庫消化（1929→1928）
