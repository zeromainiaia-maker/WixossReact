...
const PATTERNS: Pattern[] = [
  ...
  { name: 'コスト:《コイン》', re: /《コイン/, keys: ['coin', 'COIN', 'コイン'], src: 'eff',
    ...
    extraOk: (js, t) => {
      ...
      if (betPrefixes.some(p => p.includes('《コイン')) && !/BET/.test(js)) return false;
