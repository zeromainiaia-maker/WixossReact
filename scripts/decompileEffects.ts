    ...
    case 'STUB': {
      ...
      const miscStubMap: Record<string, string> = {
        ...
        CHECK_ZONE_FREE_CAST:
          'あなたのデッキの上からカードを見て、その中からコストの合計が上限以下になるようにスペルをチェックゾーンに置き、残りをデッキに加えてシャッフルする。この方法でチェックゾーンに置いたスペルを好きな順番でコストを支払わずに使用する',
        ...
        CROSS_ZONE_TRIPLE_TARGET_TO_DECK_BOTTOM:
          '対戦相手の、シグニ1体とエナゾーンにあるカード1枚とトラッシュにあるカード1枚を対象とし、あなたのエナゾーンから指定色の指定クラスのシグニを1枚ずつデッキに加えてシャッフルする。そうした場合、それらをシャッフルしてデッキの一番下に置く',
