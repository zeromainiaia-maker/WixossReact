  ...
  switch (a.type) {
    ...
    case 'STUB': {
      ...
      const miscStubMap: Record<string, string> = {
        ...
        DEFERRED_CHECK_ZONE_FREE_CAST:
          '【未実装】あなたのデッキの上からカードを10枚見る。その中からコストの合計が4以下になるようにスペルを2枚までチェックゾーンに置き、残りをデッキに加えてシャッフルする。この方法でチェックゾーンに置いたスペルを好きな順番でコストを支払わずに使用する',
