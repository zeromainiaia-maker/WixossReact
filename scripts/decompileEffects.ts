...
// ON_TARGETED は C1（2026-06-29）で配線済（BattleScreen handleEffectInteraction → collectTargetedTriggers）＝除外。
const engineUnwiredTimings = new Set<string>(['ON_DECK_SHUFFLED', 'ON_KEYWORD_GAINED', 'ON_LRIG_UNDER_MOVED', 'ON_LRIG_ATTACK_STEP_START', 'ON_LRIG_GROW', 'ON_COIN_PAID', 'ON_MATERIAL_USED', 'ON_SIGNI_BANISH_OPPONENT_BY_EFFECT', 'ON_ALLY_PLAY_OR_OPP_HAND_DISCARD']);
