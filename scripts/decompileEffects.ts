  ...
  switch (a.type) {
    ...
    case 'STUB': {
      ...
      const miscStubMap: Record<string, string> = {
        ...
        DEFERRED_CROSS_ZONE_TRIPLE_TARGET_TO_DECK_BOTTOM:
          '【未実装】対戦相手の、シグニ1体とエナゾーンにあるカード1枚とトラッシュにあるカード1枚を対象とし、あなたのエナゾーンから赤と青と緑の＜天使＞のシグニを1枚ずつデッキに加えてシャッフルする。そうした場合、それらをシャッフルしてデッキの一番下に置く',
