...
const order = ['wxk09050', 'wxk02029', 'lriggrow', 'coinpaid', 'deckshuffle', 'deckshufflespell', 'ontargeted', 'banishbyeffect', 'lrigundermoved', 'keywordgained', 'wd07012']; // 自分ターン系→CPUターンの順
